...
SQL;
        ...
        $createTable = <<<SQL
            ...
            `account_uuid` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
            `exchange_id` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
SQL;
        ...
        $createTable = <<<SQL
            ...
            `uuid` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
            `account_uuid` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
            `user_profile_uuid` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
            `panic_alert_uuid` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
SQL;
        ...
        $createTable = <<<SQL
            ...
            `uuid` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
            `panic_alert_uuid` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
            `panic_alert_status_uuid` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
            `user_profile_uuid` varchar(36) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
            `title` text,
            `created_at` datetime DEFAULT NULL,
            `updated_at` datetime DEFAULT NULL,
...
SQL;
        ...
        $alterTable = <<<SQL
            ...
            ADD KEY `vehicle_request_idx` (`vehicle_request_uuid`),
            ADD KEY `purchase_requisition_idx` (`purchase_requisition_uuid`);
            ...
            ADD KEY `customer_idx` (`customer_uuid`);
            ...
            ADD CONSTRAINT `notification_purchase_requisition_fk` FOREIGN KEY (`purchase_requisition_uuid`) REFERENCES `purchase_requisition` (`uuid`) ON DELETE NO ACTION ON UPDATE NO ACTION;
            ...
            ADD CONSTRAINT `qr_code_customer_fk` FOREIGN KEY (`customer_uuid`) REFERENCES `customer` (`uuid`) ON DELETE NO ACTION ON UPDATE NO ACTION;
            ...
            ALTER TABLE `user_profile`
            ADD CONSTRAINT `FK_user_profile_account` FOREIGN KEY (`account_uuid`) REFERENCES `account` (`uuid`) ON DELETE SET NULL ON UPDATE CASCADE,
            ADD CONSTRAINT `FK_user_profile_parent` FOREIGN KEY (`parent_uuid`) REFERENCES `user_profile` (`uuid`) ON DELETE CASCADE ON UPDATE NO ACTION,
            ADD CONSTRAINT `FK_user_profile_username` FOREIGN KEY (`username`) REFERENCES `oauth_users` (`username`) ON DELETE SET NULL ON UPDATE CASCADE,
            ...
            ALTER TABLE `user_role`
            ADD CONSTRAINT `user_role_account_fk` FOREIGN KEY (`account_uuid`) REFERENCES `account` (`uuid`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
('afc72dc8-45be-11ec-974d-0225c907dcd6', 'Education', NULL, '2021-11-15 09:49:43', '2021-11-15 09:49:43', NULL);
