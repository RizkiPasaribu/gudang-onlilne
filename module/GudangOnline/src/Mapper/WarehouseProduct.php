 ...
 * Visitor Mapper
 */
class WarehouseProduct extends AbstractMapper implements MapperInterface
{
    /**
    ...
    {
        return $this->getEntityManager()->getRepository('GudangOnline\\Entity\\WarehouseProduct');
    }
